...
const PERSONA_TEST_CASES: PersonaTestCase[] = [
  ...
  },
  {
    ...
    personaId: "plumber",
    enabledModules: ["client-database", "leads-pipeline", "jobs-projects", "bookings-calendar", "quotes-invoicing", "communication"],
    expectedLabels: {
      "client-database": "Customers",
      "leads-pipeline": "Job Requests",
      "bookings-calendar": "Site Visits",
    },
    expectedFieldExists: {
      "client-database": ["propertyType", "accessNotes"],
      "leads-pipeline": ["urgency"],
      "jobs-projects": ["siteAddress"],
    },
  },
  {
    name: "Electrician",
    ...
    enabledModules: ["client-database", "leads-pipeline", "jobs-projects", "quotes-invoicing", "communication"],
    expectedLabels: {
      "client-database": "Customers",
      "leads-pipeline": "Job Requests",
      "jobs-projects": "Jobs",
    ...
    expectedFieldExists: {
      "client-database": ["propertyType"],
      "jobs-projects": ["siteAddress", "certificateRequired"],
    },
  },
  {
    name: "Photographer",
    ...
    enabledModules: ["client-database", "leads-pipeline", "jobs-projects", "bookings-calendar", "quotes-invoicing", "products", "communication"],
    expectedLabels: {
      "leads-pipeline": "Inquiries",
      "jobs-projects": "Shoots",
      "bookings-calendar": "Sessions",
      "products": "Packages",
    },
    expectedFieldExists: {
      "client-database": ["shootType"],
      "leads-pipeline": ["eventDate", "shootType"],
      "jobs-projects": ["shootDate", "location"],
    },
  },
  {
  ...
  },
  {
    ...
    expectedFieldExists: {
      "client-database": ["fitnessGoal", "injuries", "preferredTime"],
      "bookings-calendar": ["sessionType", "location"],
    },
  },
  {
    name: "Tutor",
    ...
    enabledModules: ["client-database", "leads-pipeline", "bookings-calendar", "quotes-invoicing", "products", "communication"],
    expectedLabels: {
      "client-database": "Students",
      "bookings-calendar": "Lessons",
      "products": "Rates",
      "quotes-invoicing": "Billing",
      "leads-pipeline": "Inquiries",
    },
    expectedFieldExists: {
      "client-database": ["yearLevel", "subjects", "learningNotes"],
      "bookings-calendar": ["subject", "lessonLocation"],
    },
  },
  {
    name: "Life Coach",
    ...
    expectedFieldExists: {
      "client-database": ["coachingGoal", "programName"],
      "bookings-calendar": ["sessionFormat"],
    },
  },
  {
    ...
    enabledModules: ["client-database", "leads-pipeline", "jobs-projects", "quotes-invoicing", "communication"],
    expectedLabels: {
      "client-database": "Couples",
      "leads-pipeline": "Inquiries",
      "jobs-projects": "Weddings",
    },
    expectedFieldExists: {
      "client-database": ["weddingDate", "venue", "guestCount", "budget"],
    },
  },
];
