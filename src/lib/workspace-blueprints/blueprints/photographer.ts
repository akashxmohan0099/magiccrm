...
export const photographerBlueprint: WorkspaceBlueprint = {
  id: "creative-services:photographer",
  label: "Photographer",
  description: "Inquiry-first workspace for photographers — leads pipeline, proposals, project tracking, and deposit invoicing.",
  ...
  adjustableBlocks: [
    ...
    {
      id: "track-projects",
      question: "Do you track editing and delivery as projects?",
      options: [
        {
          value: "yes",
        ...
        },
        {
          ...
          description: "Simplified — no project tracking, just invoicing after the shoot.",
