...
export const educationDefaultBlueprint: WorkspaceBlueprint = {
  id: "education-coaching:default",
  label: "Education & Coaching",
  description: "Recurring workspace for educators and coaches — lesson scheduling, session packs, student tracking, and attendance.",
  ...
  presentation: {
    ...
    modulePresentation: {
      clients: {
        defaultColumns: ["name", "email", "phone", "status", "tags", "field_year-level", "field_subjects"],
      ...
      options: [
        {
          value: "no",
          label: "1-on-1 only",
          description: "Private sessions only.",
          presentationPatches: [],
        },
        {
          value: "yes",
