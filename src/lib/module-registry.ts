...
export const MODULE_REGISTRY: ModuleDefinition[] = [
  ...
  { id: "payments", slug: "payments", name: "Payments", icon: "CreditCard", description: "Track who's paid and who hasn't.", group: "business" },
  { id: "documents", slug: "documents", name: "Documents", icon: "FileText", description: "Contracts, files, and signatures.", group: "business" },
  ...
  { id: "support", slug: "support", name: "Support", icon: "Headphones", description: "Track client requests and follow-ups.", group: "grow" },
  ...
  { id: "client-portal", slug: "portal", name: "Client Portal", icon: "Globe", description: "Self-service hub where clients view bookings, invoices, and docs.", group: "grow", kind: "addon" },
