...
import { Plus, Clock, DollarSign, Trash2, ChevronDown, ChevronRight, Save, X } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-sm font-semibold text-foreground">Service Menu</h2>
