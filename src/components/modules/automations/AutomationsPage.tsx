...
import { RecurringTemplateLibrary } from "./RecurringTemplateLibrary";
    ...
    <div>
      ...
      {rules.length === 0 ? (
        ...
        <>
          ...
          <FeatureSection moduleId="automations" featureId="automation-templates" featureLabel="Recurring Task Templates">
            <RecurringTemplateLibrary />
          </FeatureSection>
